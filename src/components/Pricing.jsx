...
export default function Pricing(){
  ...
  return(
    <section id="pricing" style={{background:'#333333',borderTop:'1px solid #4a4a4a'}}>
      <div style={{maxWidth:900,margin:'0 auto'}}>
        ...
        <div style={{display:'flex',flexDirection:'column',gap:8}}>
          {PLANS.map((plan,i)=>(
            <div key={i} className="reveal drawer-item" style={{border:`1px solid ${plan.popular?'#84cc16':'#4a4a4a'}`,position:'relative'}}>
