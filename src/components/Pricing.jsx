...
export default function Pricing(){
  ...
  return(
    <section id="pricing" style={{background:#000000,borderTop:'1px solid #000000}}>
      <div style={{maxWidth:900,margin:'0 auto'}}>
        ...
        <div style={{display:'flex',flexDirection:'column',gap:8}}>
          {PLANS.map((plan,i)=>(
            <div key={i} className="reveal drawer-item" style={{border:`1px solid ${plan.popular?'#84cc16':#000000}`,position:'relative'}}>
              ...
              {open===i&&(
                <div style={{padding:'0 20px 20px',borderTop:'1px solid #000000}}>
                  ...
                  <a href="#contact" style={{display:'inline-block',padding:'10px 24px',borderRadius:8,background:'#84cc16',color:'#292121',fontSize:13,fontWeight:700}}>
