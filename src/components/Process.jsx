...
export default function Process(){
  ...
  return(
    <section id="process" style={{background:'#333333',borderTop:'1px solid #4a4a4a'}}>
          ...
          {open&&(
            <div style={{padding:'0 20px 20px',borderTop:'1px solid #4a4a4a'}}>
              <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(200px,1fr))',gap:12,marginTop:16}} className="proc-grid">
                {STEPS.map(s=>(
                  <div key={s.n} style={{background:'#404040',border:'1px solid #4a4a4a',borderRadius:10,padding:20}}>
        ...
        <div className="reveal" style={{marginTop:32}}>
          ...
          <div style={{display:'flex',flexWrap:'wrap',gap:8}}>
            {CHIPS.map(c=>(
              ...
              onMouseLeave={e=>{e.target.style.background='#3a3a3a';e.target.style.borderColor='#4a4a4a';e.target.style.color='#999'}}>
                {c}
              </span>
            ))}
          </div>
