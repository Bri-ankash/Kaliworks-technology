...
export default function Reviews(){
  ...
  return(
    <section id="reviews" style={{background:'#333333',borderTop:'1px solid #4a4a4a'}}>
      <div style={{maxWidth:900,margin:'0 auto'}}>
          ...
          {open&&(
            <div style={{padding:'0 20px 20px',borderTop:'1px solid #4a4a4a'}}>
              {approved.length===0?(
                ...
                <div key={r.id} style={{padding:'16px 0',borderBottom:i<approved.length-1?'1px solid #4a4a4a':'none'}}>
        ...
        {/* Leave a review */}
        <div className="reveal" style={{background:'#3d3d3d',border:'1px solid #4a4a4a',borderRadius:12,padding:24,marginBottom:16}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:12}}>
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12}}>
                <input value={form.name} onChange={e=>setForm(f=>({...f,name:e.target.value}))}
                  ...
                  style={{background:'#404040',border:'1px solid #4a4a4a',borderRadius:8,padding:'10px 14px',color:'#fff',fontSize:13,outline:'none'}}
              ...
              <textarea value={form.text} onChange={e=>setForm(f=>({...f,text:e.target.value}))}
                ...
                style={{background:'#404040',border:'1px solid #4a4a4a',borderRadius:8,padding:'10px 14px',color:'#fff',fontSize:13,outline:'none',resize:'vertical'}}
                onFocus={e=>e.target.style.borderColor='#84cc16'}
                onBlur={e=>e.target.style.borderColor='#4a4a4a'}/>
        ...
        <div className="reveal">
          ...
          {adminInput&&(
            <div style={{display:'flex',gap:8,alignItems:'center'}}>
              <input type="password" value={adminKey} onChange={e=>setAdminKey(e.target.value)} placeholder="Admin key"
                style={{background:'#3d3d3d',border:'1px solid #4a4a4a',borderRadius:6,padding:'6px 12px',color:'#fff',fontSize:12,outline:'none',width:140}}/>
          ...
          {adminMode&&(
            <div style={{background:'#3d3d3d',border:'1px solid rgba(132,204,22,0.2)',borderRadius:10,padding:16}}>
