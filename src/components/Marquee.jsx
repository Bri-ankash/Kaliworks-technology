export default function Marquee(){
  ...
  return(
    <div style={{background:'#000',borderTop:'1px solid rgba(14,165,233,0.12)',borderBottom:'1px solid rgba(14,165,233,0.12)',overflow:'hidden',padding:'14px 0',position:'relative',zIndex:1}}>
